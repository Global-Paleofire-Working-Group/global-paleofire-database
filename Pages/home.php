        ...
        <div class="row">
            <div style="margin: 0 auto; width: 72%">
                <a href="http://www.pages.unibe.ch/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/PAGES.jpg" alt=""/></p></div></a>
                <a href="http://www.univ-fcomte.fr/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/UFC.jpg" alt=""/></p></div></a>
                <a href="http://www.franche-comte.fr/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/BFC.jpg" height="85" alt=""/> </p></div></a>                
            </div>
        </div>
        <div class="row">
            <div style="margin: 0 auto; width: 72%">
                <a href="http://www.cnrs.fr/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/CNRS.png" height=30 alt=""/> </p></div></a>
                <a href="http://chrono-environnement.univ-fcomte.fr/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/chrono_environnement.png" height=30 alt=""/> </p></div></a>
                <a href="http://www.umontreal.ca/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/udm.gif" height=30 alt=""/> </p></div></a>
                <a href="http://www.geog.utah.edu/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/geogU.png" height=30 alt=""/> </p></div></a>
                <a href="http://www.oeschger.unibe.ch/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/oeschger.png" height=30 alt=""/> </p></div></a>
                <a href="http://www.epoc.u-bordeaux.fr/" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/epoc.gif" height=30 alt=""/> </p></div></a>
                <a href="http://www.yale.edu" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/yale.jpg" height=30 alt=""/> </p></div></a>
                <a href="http://www.nsf.gov" target="_blank">
                    <div class="logo"><p> <img src="./images/logo/nsf.jpg" height=30 alt=""/> </p></div></a>
            </div>
        </div>
    </div>
    <!--<div class="home_footer">
        Global Paleofire Working Group (<a href="http://gpwg.org" target="_new">http://gpwg.org</a>)
    </div>-->
</div>
...
<SCRIPT language="JavaScript">
    ...
    if (htmlVersion >= 5) {
        ...
        this.document.write("This is HTML 4 or or an earlier version. Some html tags aren't available<BR>\n");
    }
</SCRIPT>