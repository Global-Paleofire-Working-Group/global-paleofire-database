            ...
            <table class="table table-bordered table-condensed table-responsive">
                ...
                $coord = null;
                    foreach($site->getListeCoreEtCumuls() as $core){
                        ...
                        $liste_methods = [];
                        $tab = explode(',',$core['list_methods']);
                        foreach($tab as $method_id){
                            $liste_methods[] = CharcoalMethod::getNameFromStaticList($method_id);
                        }
                        echo '<td class="small">'. implode(', ', $liste_methods)."</td>";
                        $liste_units = [];
                        $tab = explode(',',$core['list_units']);
                        foreach($tab as $unit_id){
                            $liste_units[] = CharcoalUnits::getNameFromStaticList($unit_id);
                        }
                        echo '<td class="small">'. implode(', ', $liste_units)."</td>";
                        echo '<td><a class="btn btn-default btn-lg active btn-xs" role="button" href="index.php?p=CDA/core_view&gcd_menu=CDA&core_id='.$core[Core::ID].'">'
