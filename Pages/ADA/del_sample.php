<?php
/* 
 * fichier Pages/ADA/del_sample.php 
 * 
 */
...
function del_sample(){
    ...
    if (isset($_GET['id'])) {
        ...
        $obj = Sample::getObjectPaleofireFromId($id);
        if (isset($obj) && $obj != null){
            if (Sample::delObjectPaleofireFromId($id)){
                //xli ajout des infos dans le fichier log qui sera envoyé par mail aux administrateurs
                writeChangeLog("del_sample",$id); 
               
                echo '<div class="alert alert-success"><strong>Success ! </strong>The sample has been deleted.</div>';
            } else {
            ...
            echo '<div class="btn-toolbar" role="toolbar" style="float:left">
                    <a role="button" class="btn btn-default btn-xs" href="index.php?p=CDA/sample_view&gcd_menu=CDA">
