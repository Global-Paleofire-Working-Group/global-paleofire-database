...
<script>
    ...
    function verificationPays(){
	    ...
	    let apiurl = 'https://www.mapquestapi.com/geocoding/v1/reverse?key=<?php echo "MOxZkfZDCk9agm8GtJXK8KGWVwhC4kGp"; ?>&location=' + latlng.lat + '%2C'+ latlng.lng + '&outFormat=json&thumbMaps=false'
	    let request = new XMLHttpRequest();
	    request.open('GET', apiurl, true);
	    request.onload = function() {
		    let data = JSON.parse(this.response);
