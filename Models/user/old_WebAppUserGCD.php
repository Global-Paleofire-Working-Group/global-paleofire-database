...
class WebAppUserGCD extends WebAppUser {
    ...
    const TABLE_NAME = BDD_USER_USERTABLE;
    ...
    public static function instantiate($id_user) {
        ...
        if ($request_values == NULL || empty($request_values)) {
            ...
            $user = new WebAppUserGCD($request_values[self::LOGINFIELD], $request_values[self::PASSWORDFIELD], $request_values[self::ID_ROLE], $request_values[self::ID_CONTACT]);
