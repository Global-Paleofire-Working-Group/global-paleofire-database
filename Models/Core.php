...
class Core extends ObjectPaleofire {
    ...
    public static function getCoreDataFromID($id){
      $query = "select ID_CORE as id_core, CORE_NAME,ID_SITE, LATITUDE, LONGITUDE,";
      $query .= " ELEVATION, WATER_DEPTH, ID_DEPO_CONTEXT, ID_AFFILIATION,";
      $query .= "ID_CORE_TYPE from t_core ";
      $query .= "where ID_CORE = $id";
