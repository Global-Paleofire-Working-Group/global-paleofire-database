...
WHERE t_site.ID_SITE = " . $id_site . ";";
    ...
    public static function getDataForExport($id_region, $id_country, $id_site, $selected_fields, $selected_fieldsSample, $selected_fieldsDateInfo, $oldGcdCodeIncluded = false){
        $result = null;
    ...
    public static function getDataForExportbyCoreIDS($tabIds, $selected_fields, $selected_fieldsSample, $selected_fieldsDateInfo, $oldGcdCodeIncluded = false){      
        // beaucoup de données à gérer, on augmente temporairement la mémoire alouée
        // (ini_set n'est valable que pendant le script) 
        ini_set('memory_limit', '512M');
