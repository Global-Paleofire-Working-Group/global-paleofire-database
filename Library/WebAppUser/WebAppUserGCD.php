...
include_once("./Library/WebAppUser/WebAppUser.php");

class WebAppUserGCD extends WebAppUser {

    //const TABLE_NAME = BDD_USER_USERTABLE; //xli 01/06
    const TABLE_NAME = "paleofire_user" ;//xli 01/06
     ...
     * */
    private $_webAppUser_role;
    private $_webAppUser_id;
    ...
    public static function getContactId($user_id) {
        var_dump("idcontact=".self::ID_CONTACT);
        var_dump("TABLENAME=".self::TABLE_NAME);
        var_dump("selfIDENTIFIER=".self::IDENTIFIER);
    ...
    public function save() {
        ...
        var_dump("obj_exists=".$obj_exists);
        //BEGIN TRANSACTION
        beginTransaction();
